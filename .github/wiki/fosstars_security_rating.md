...
1.  **[Project activity](#project-activity)**: **5.65** (weight is 0.5)
...
Score: **5.65**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

35 commits in the last 3 months results to 5.38 points
2 contributors increase the score value from 5.38 to 5.65
